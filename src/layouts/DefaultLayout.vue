  ...
  <div id="TopNav"
    ...
    <div>
      ...
      <button v-if="searchTerm" @click="searchTerm = ''"
        class="absolute top-1/2 transform -translate-y-1/2 right-3 text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50"></button>
    </div>
