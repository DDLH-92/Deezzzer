  ...
  <div id="MusicPlayer" v-if="audio" class="
    ...
    <div class="flex items-center w-2/12">
      <div class="flex items-center justify-center h-[30px] pl-4">
        ...
        <button type="button" class="p-2 w-[8] rounded-full hover:bg-green-500"
        ...
        <button type="button" class="mx-2 p-2 rounded-full hover:bg-[#363636]" @click="useSong.nextSong(currentTrack)">
    ...
    <div class="flex items-center w-1/4 justify-end pr-6 ">
      ...
      <div class="flex items-center ml-6 border-l border-l-[#363636]">
        <img class="rounded-sm ml-6" width="28" :src="currentTrack.album.cover">
      </div>
    </div>
  </div>
</template>
